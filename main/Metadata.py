...
def createSolanaMetaData(name, Order_Num, NFT_DNA, NFT_Variants, Material_Attributes, custom_Fields, enableCustomFields,
    ...
    metaDataDictSolana = {"name": name.replace('_', ' #'), "symbol": "MFL", "description": "Metafigz Legs is the final part of Metafigz Citizen. Create your own character to form a new city and get staking rewards.", "seller_fee_basis_points": 1000,
